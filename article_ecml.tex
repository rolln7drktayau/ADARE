...
Numerically, V2 and V3 already improve over V1, but gains remain modest and less consistent across benchmarks (quality wins: 11/18 and 14/18). V4 and V5 are both stronger (18/18 quality wins), with V5 giving the best mean core-quality gain. In Table~\ref{tab:ablation_design}, N/Y/P denote No/Yes/Partial for module activation. This supports the stacked-control reading: the combined modules matter more than any isolated toggle.
